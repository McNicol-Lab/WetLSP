...
```{r}
r <- rast("Product_GeoTiff/US-Tw1/2024/09_2024_EVImax.tif")
...
```{r use-mapper}
sf_chunk <- readRDS("US-Tw1/tables_sf/chunk_100_evi_sf.rds")
PickPixelInteractive(sf_chunk)
ViewPixelTimeseries(sf_chunk, cell_vec = c(seq(674963, 675263, by = 30)))
```
