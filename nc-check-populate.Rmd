...
define_path <- paste0("output/AT-Nsd/netcdf/WetLSP_", i, ".nc")
define_patch_path <- paste0("output/AT-Nsd/netcdf/AT-Nsd-wetlsp-", i, ".nc")
  ...
  patch_cf_coords_and_grid_mapping(define_patch_path)
...
```{r output}
nc_path <- file.path(site_dir, "netcdf/AT-Nsd-wetlsp-2021.nc")
nc <- nc_open(nc_path)
nc
nc_close(nc)
```
