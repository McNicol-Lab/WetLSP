...
########################################
# Do a loop for 8 years; 2017-2024
for(yy in 1:8){
  # Load files
  ...
  ncatt_put(ncout,0,"summary","A High Spatial Resolution Land Surface Phenology from PlanetScope for FLUXNET-CH4 Wetlands")
  ncatt_put(ncout,0,"software_repository","https://github.com/McNicol-Lab/WetLSP")

  ncatt_put(ncout,0,"origin_creator_name","Land Cover & Surface Climate Group, Department of Earth & Environment, Boston University")
  ncatt_put(ncout,0,"origin_creator_type","group")
  ncatt_put(ncout,0,"origin_creator_email","mkmoon@bu.edu")
  ncatt_put(ncout,0,"origin_creator_institution","Boston University")
  
  ncatt_put(ncout,0,"fork_creator_name","Ecosystem and Planetary Health Integration (ecophi) Lab, Department of Earth and Environmental Sciences, University of Illinois Chicago")
  ncatt_put(ncout,0,"fork_creator_type","group")
  ncatt_put(ncout,0,"fork_creator_email","gmcnicol@uic.edu")
  ncatt_put(ncout,0,"fork_creator_institution","University of Illinois Chicago")
  
  ncatt_put(ncout,0,"origin_contributor_name", "Minkyu Moon, Andrew R. Richardson, Thomas Milliman, Mark A. Friedl")
  ncatt_put(ncout,0,"origin_contributor_role", "Developer, Co-Investigator, Collabolator, Principal Investigator")
  ncatt_put(ncout,0,"origin_acknowledgement","This work was supported by NASA grant #80NSSC18K0334 and by NSF award #1702627.")
  
  ncatt_put(ncout,0,"fork_contributor_name", "Gavin McNicol, Aarin Bothra, Youmi Oh, Lichen Liu, Sparkle Malone, Qing Zhu")
  ncatt_put(ncout,0,"fork_contributor_role", "Developer, Collaborator, Lead Investigator (DOE, ESIIL), Co-Investigator (DOE, ESIIL), Co-Investigator (DOE, ESIIL), Lead Investigator (NASA)")
  ncatt_put(ncout,0,"fork_acknowledgement","This project was supported by NASA Carbon Monitoring System Grant #NNH20ZDA001N, DOE BER ESS Grant #DE-SC0024360, and NSF ESIIL Workshop Funding AI for Naural Methane #2153040.")
