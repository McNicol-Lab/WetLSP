...
r_prod <- terra::rast(prod_files[9])

# If values are stored as scaled integers, divide by 10000 if appropriate.
plot(r_prod / 10000,
     main = paste0(site_prod, " – ", basename(prod_files[9]), " (scaled)"),
     axes = TRUE)
```
...
ViewPixelTimeseries(sf_all, cell_vec = c(seq(612082, 612882, by = 100)))
```
## Summarize _sf chunk
